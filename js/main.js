...
const projectData = [
  {
    ...
    thumbnail: "../img/postit.png",
    description:
      "POSTIT is a website where you can post tasks to do, modify them and delete them if necessary. The data is managed by an api and the technology used is Vuejs.",
  ...
  },
  {
    ...
    thumbnail: "../img/TWP.png",
    description:
      "TWP is a task management website like Trello. It's a platform that lets you add tasks to a category and comment on them. My application also lets you drag and drop elements. It's great.  All managed with Vuejs",
    techStack: ["Vuejs", "Tailwind CSS"],
    srcURL: "",
  },
  {
    ...
    thumbnail: "../img/yawl.png",
    description:
      "Yowl is an application that lets you comment on everything on the Internet. Yowl breaks the barriers and restrictions of any community. With Yawl, everyone is free to express themselves. On Yawl you can publish content, comment, see your kpi, manage your user profile and more.",
    techStack: ["Vue.js", "Laravel", "Tailwind", "Docker"],
    srcURL: "",
  },
  {
    title: "My Shop",
    thumbnail: "../img/prod.png",
    description:
      "My shop is an e-commerce site where you can search for and purchase products. The site has an admin area for managing users and products.",
    techStack: ["PHP", "HTML/CSS"],
  },
  {
    title: "FREEADS",
    subTitle: "Gain insights and strengthen your GitHub connections",
    thumbnail: "../img/free.png",
    description:
      "FREEADS is a clothing sales site where you can browse and buy products. There's an admin area to manage users and add products. ",
  ...
  },
  {
    ...
    thumbnail: "../img/dash.png",
    description:
      "Welcome to the Dashboard project! This application is a customizable online dashboard that integrates various services through widgets. Built with a modern tech stack, this project allows users to create a personalized dashboard experience by selecting and using various widgets.The Dashboard project is designed to provide users with a flexible and interactive dashboard. Users can sign in or log in to customize their dashboard by selecting the widgets they want to use. Each widget corresponds to a specific service, offering a range of functionalities",
    techStack: ["ReactJs", "ExpressJs", "NestJs", "Tailwind CSS", "Docker", "Jenkins", "MongoDB"],
    srcURL: "",
  },
  {
    ...
    description:
      "My rotten tomatoes is a two-part site. A user section where you can browse movies, comment and rate them, add them as favorites and filter them. An admin panel that runs an api and manages movies and users. Users can be admins or not. The site was built with Nextjs",
    techStack: ["Nextjs", "Docker","MongoDB", "Tailwind CSS"],
    srcURL: "",
  },
  {
    title: "Trelltech",
    ...
    thumbnail: "../img/trell.png",
    description:
      "Trelltech is a mobile task management application like Trello that uses the Trello api and offers a connection via Trello.",
    ...
    elem.innerHTML = buildTemplate(
      `<div class='projects-header'>
       ...
       <div class="card-buttons">
          <a href="https://github.com/stonefadel02" target="_blank" class="card-btn" style="float: right; height: 2.35rem; color: #fff; background-color: #68d372; padding: .375rem .75rem; border-radius: .25rem;"><i class="fa-regular fa-file-code"></i>Source Code</a>
